...
public class StatementParametersTest {
    ...
    public void testDuplicate() {
        ...
        assertEquals(Integer.valueOf(1), test.get(0).getValue());
        assertEquals(Integer.valueOf(2), test.get(1).getValue());

        assertEquals(Integer.valueOf(2), test2.get(0).getValue());
        assertEquals(Integer.valueOf(2), test2.get(1).getValue());

        assertEquals(Integer.valueOf(3), test3.get(0).getValue());
        assertEquals(Integer.valueOf(2), test3.get(1).getValue());
    }
...
//        test for api int setInParameter(int index, List<?> values)
        ...
        assertEquals(Integer.valueOf(1), test2.get(0).getValue());
        ...
        assertEquals(Integer.valueOf(1), test2.get(2).getValue());
        assertEquals(Integer.valueOf(2), test2.get(3).getValue());
        assertEquals(Integer.valueOf(3), test2.get(4).getValue());
    ...
    public void testBuildParameters() {
        ...
        assertEquals(1, test.get(0).getIndex());
        assertEquals(Integer.valueOf(50), test.get(0).getValue());

        assertEquals(2, test.get(1).getIndex());
        assertEquals(Integer.valueOf(20), test.get(1).getValue());

        assertEquals(3, test.get(2).getIndex());
        assertEquals(Integer.valueOf(60), test.get(2).getValue());
    }
    ...
    public void testParametersWithDiscontinuousIndex() {
        ...
        assertEquals(2, test.get(1).getIndex());
        assertEquals(Integer.valueOf(60), test.get(1).getValue());

        assertEquals(3, test.get(2).getIndex());
        assertEquals(Integer.valueOf(20), test.get(2).getValue());
    }
...
//        test for api public StatementParameters set(int index, String name, Object value)
        ...
        assertEquals(Integer.valueOf(10), test.get(0).getValue());
        ...
        assertEquals(Integer.valueOf(50), test.get(2).getValue());
...
//      test for api StatementParameters set(String name, Object value)
        ...
        assertEquals(Integer.valueOf(80), test2.get(0).getValue());

        assertEquals(2, test2.get(1).getIndex());
        assertEquals("param3", test2.get(1).getName());
        assertEquals(Integer.valueOf(30), test2.get(1).getValue());

        assertEquals(3, test2.get(2).getIndex());
        assertEquals("param10", test2.get(2).getName());
        assertEquals(Integer.valueOf(100), test2.get(2).getValue());
    }
